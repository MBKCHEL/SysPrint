...
pub fn get_logo(mini: bool) -> (Vec<ColoredString>, usize, fn(&str) -> ColoredString) {
    ...
    let (raw_logo, color_func): (&str, fn(&str) -> ColoredString) = if mini {
        ...
        match os_name.as_str() {
            ...
            s if s.contains("opensuse")     => (include_str!("../assets/mini/opensuse.txt"), |s| s.green().bold()),
            ...
            s if s.contains("endeavour")   => (include_str!("../assets/mini/endeavour.txt"), |s| s.purple().bold()),
        ...
        match os_name.as_str() {
            ...
            s if s.contains("opensuse")     => (include_str!("../assets/normal/opensuse.txt"), |s| s.green().bold()),
            ...
            s if s.contains("endeavour")   => (include_str!("../assets/normal/endeavour.txt"), |s| s.purple().bold()),
